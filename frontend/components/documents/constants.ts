...
export const ACCEPTED_FILE_TYPES = '.pdf,.doc,.docx,.txt,.csv,.tsv,.xlsx,.xls,.xlsm,.xlsb,.pptx,.ppt,.rtf,.ods,.numbers,.json,.xml,.html,.htm,.md,.zip,.png,.jpg,.jpeg,.gif,.bmp,.tiff,.tif,.heic,.heif,.mp4,.mov,.wav,.mp3,.m4a,.webm'
