...
const PUBLIC_ROUTES = ['/', '/login', '/signup', '/forgot-password', '/reset-password', '/verify-email', '/verification-pending', '/terms', '/privacy', '/landing', '/product', '/high-impact-journal', '/co-researcher', '/reproducibility-archive', '/research-reproducibility', '/never-worked']
